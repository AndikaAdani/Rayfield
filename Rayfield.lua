...
function RayfieldLibrary:CreateWindow(Settings)
	...
	Topbar.Divider.Size = UDim2.new(0, 0, 0, 0)
	...
	wait(0.1)
	TweenService:Create(Topbar.Divider, TweenInfo.new(1, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	wait(0.1)
